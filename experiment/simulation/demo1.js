...
function btntable() {
    ...
    if (current_readings != percent) {
        current_readings = percent;
        readings = true;
    }
...
if(readings){
    ...
    alert("You can add maximum 10 readings in the table")
    }
...
function makegraph() {
    if (counter < 7) {
        ...
        var layout = {
            width: 580,
            title: "<b>Speed (RPM) vs Current (A)</b>",
            margin:{
                r: 15,
                t: 90,
                b: 50, 
...
jsPlumb.ready(function () {
    ...
    document.getElementById("check-button").addEventListener("click", function () {
        ...
        if (is_connected_1_12 && is_connected_1_13 && is_connected_1_15 && is_connected_2_3 && is_connected_6_17 && is_connected_7_11 && is_connected_8_5 && is_connected_9_14 && is_connected_9_10 && is_connected_14_10 && is_connected_4_16 && !unallowed_connection_present) {
            ...
            alert("Correct connections proceed to take readings.");
